 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-ashkelon-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-ashkelon-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-ashkelon-events.mjs --json prisma/data/events-ashkelon.json
 *   node scripts/scrapers/scrape-all-ashkelon-events.mjs --debug                       # dump raw listings
 */
