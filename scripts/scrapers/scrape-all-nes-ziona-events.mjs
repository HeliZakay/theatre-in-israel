 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-nes-ziona-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-nes-ziona-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-nes-ziona-events.mjs --json prisma/data/events-nes-ziona.json
 *   node scripts/scrapers/scrape-all-nes-ziona-events.mjs --debug                       # dump DOM per page
 */
