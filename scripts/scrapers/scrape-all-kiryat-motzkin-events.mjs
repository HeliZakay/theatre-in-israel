 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-kiryat-motzkin-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-kiryat-motzkin-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-kiryat-motzkin-events.mjs --json prisma/data/events-kiryat-motzkin.json
 *   node scripts/scrapers/scrape-all-kiryat-motzkin-events.mjs --debug                       # dump DOM per page
 */
