 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-habima-theatre-events.mjs <show-url>             # dry-run
 *   node scripts/scrapers/scrape-habima-theatre-events.mjs <show-url> --debug     # dump DOM
 *   node scripts/scrapers/scrape-habima-theatre-events.mjs <show-url> --apply     # write to DB
 */
...
if (!url) {
  console.error(
    red(
      "Usage: node scripts/scrapers/scrape-habima-theatre-events.mjs <show-url> [--debug] [--apply]",
    ),
  );
  process.exit(1);
}
