 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-beer-sheva-venue-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-beer-sheva-venue-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-beer-sheva-venue-events.mjs --json prisma/data/events-beer-sheva-venue.json
 *   node scripts/scrapers/scrape-all-beer-sheva-venue-events.mjs --debug                       # dump DOM per page
 */
