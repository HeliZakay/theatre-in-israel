 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-kfar-saba-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-kfar-saba-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-kfar-saba-events.mjs --json prisma/data/events-kfar-saba.json
 *   node scripts/scrapers/scrape-all-kfar-saba-events.mjs --debug                       # dump DOM per page
 */
