 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-rehovot-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-rehovot-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-rehovot-events.mjs --json prisma/data/events-rehovot.json
 *   node scripts/scrapers/scrape-all-rehovot-events.mjs --debug                       # dump raw listings
 */
