 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-holon-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-holon-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-holon-events.mjs --json prisma/data/events-holon.json
 *   node scripts/scrapers/scrape-all-holon-events.mjs --debug                       # dump DOM per page
 */
