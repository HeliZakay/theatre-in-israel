 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-theatron-hazafon-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-theatron-hazafon-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-theatron-hazafon-events.mjs --json prisma/data/events-theatron-hazafon.json
 *   node scripts/scrapers/scrape-all-theatron-hazafon-events.mjs --debug                       # dump raw listings
 */
