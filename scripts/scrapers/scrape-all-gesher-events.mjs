 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-gesher-events.mjs                                              # dry-run
 *   node scripts/scrapers/scrape-all-gesher-events.mjs --apply                                      # write to DB
 *   node scripts/scrapers/scrape-all-gesher-events.mjs --json prisma/data/events-gesher.json        # JSON file
 *   node scripts/scrapers/scrape-all-gesher-events.mjs --debug                                      # dump DOM per show
 */
