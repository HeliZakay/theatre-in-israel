 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-khan-events.mjs                                              # dry-run
 *   node scripts/scrapers/scrape-all-khan-events.mjs --apply                                      # write to DB
 *   node scripts/scrapers/scrape-all-khan-events.mjs --json prisma/data/events-khan.json          # JSON file
 *   node scripts/scrapers/scrape-all-khan-events.mjs --debug                                      # dump DOM per show
 */
