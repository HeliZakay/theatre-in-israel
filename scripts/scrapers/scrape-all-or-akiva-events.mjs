 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-or-akiva-events.mjs                              # dry-run
 *   node scripts/scrapers/scrape-all-or-akiva-events.mjs --apply                       # write to DB
 *   node scripts/scrapers/scrape-all-or-akiva-events.mjs --json prisma/data/events-or-akiva.json
 *   node scripts/scrapers/scrape-all-or-akiva-events.mjs --debug                       # dump raw listings
 */
