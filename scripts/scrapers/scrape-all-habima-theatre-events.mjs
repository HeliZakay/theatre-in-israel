 ...
 *
 * Usage:
 *   node scripts/scrapers/scrape-all-habima-theatre-events.mjs                                                        # dry-run
 *   node scripts/scrapers/scrape-all-habima-theatre-events.mjs --apply                                                 # write to DB
 *   node scripts/scrapers/scrape-all-habima-theatre-events.mjs --json prisma/data/events-habima-theatre.json          # JSON file
 *   node scripts/scrapers/scrape-all-habima-theatre-events.mjs --debug                                                 # dump DOM per show
 */
