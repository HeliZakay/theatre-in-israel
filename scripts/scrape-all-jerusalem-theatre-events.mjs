 ...
 *
 * Usage:
 *   node scripts/scrape-all-jerusalem-theatre-events.mjs                              # dry-run
 *   node scripts/scrape-all-jerusalem-theatre-events.mjs --apply                       # write to DB
 *   node scripts/scrape-all-jerusalem-theatre-events.mjs --json prisma/data/events-jerusalem-theatre.json
 *   node scripts/scrape-all-jerusalem-theatre-events.mjs --debug                       # dump DOM per page
 */
