/**
 * Or Yehuda venue scraper — scrapes events from היכל התרבות אור יהודה.
 *
 * Site: oryehuda.smarticket.co.il (SmartTicket platform)
 * Listing page (/תאטרון_page_23) shows event cards — slug-based hrefs.
...
export const VENUE_NAME = "היכל התרבות אור יהודה";
export const VENUE_CITY = "אור יהודה";
export const LISTING_URL =
  "https://oryehuda.smarticket.co.il/%D7%AA%D7%90%D7%98%D7%A8%D7%95%D7%9F_page_23";
