 ...
 *
 * Usage:
 *   node scripts/scrape-haifa-theatre-events.mjs <show-url>             # dry-run
 *   node scripts/scrape-haifa-theatre-events.mjs <show-url> --debug     # dump DOM
 *   node scripts/scrape-haifa-theatre-events.mjs <show-url> --apply     # write to DB
 */
...
if (!url) {
  console.error(
    red(
      "Usage: node scripts/scrape-haifa-theatre-events.mjs <show-url> [--debug] [--apply]",
    ),
  );
  process.exit(1);
}
