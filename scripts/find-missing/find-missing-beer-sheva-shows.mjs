 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-beer-sheva-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-beer-sheva-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-beer-sheva-shows.mjs --html          # HTML report
 */
