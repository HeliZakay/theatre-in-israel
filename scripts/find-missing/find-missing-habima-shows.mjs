 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-habima-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-habima-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-habima-shows.mjs --html          # HTML report
 */
