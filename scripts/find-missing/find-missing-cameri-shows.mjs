 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-cameri-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-cameri-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-cameri-shows.mjs --html          # HTML report
 */
