 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-hebrew-theatre-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-hebrew-theatre-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-hebrew-theatre-shows.mjs --html          # HTML report
 */
