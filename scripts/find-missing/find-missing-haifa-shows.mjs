 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-haifa-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-haifa-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-haifa-shows.mjs --html          # HTML report
 */
