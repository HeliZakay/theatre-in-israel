 ...
 *
 * Usage:
 *   node scripts/find-missing/find-missing-hakahn-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing/find-missing-hakahn-shows.mjs --json          # JSON output
 *   node scripts/find-missing/find-missing-hakahn-shows.mjs --html          # HTML report
 */
