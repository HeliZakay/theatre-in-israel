 ...
 *
 * Usage:
 *   node scripts/scrape-all-ashdod-events.mjs                              # dry-run
 *   node scripts/scrape-all-ashdod-events.mjs --apply                       # write to DB
 *   node scripts/scrape-all-ashdod-events.mjs --json prisma/data/events-ashdod.json
 */
...
async function main() {
  separator();
  console.log(bold(cyan("  Ashdod Venue Scraper — המשכן לאמנויות הבמה אשדוד")));
  console.log(
    dim(
