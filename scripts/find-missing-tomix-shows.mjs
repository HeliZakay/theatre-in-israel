 ...
 *
 * Usage:
 *   node scripts/find-missing-tomix-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing-tomix-shows.mjs --json          # JSON output
 *   node scripts/find-missing-tomix-shows.mjs --html          # HTML report
 */
