 ...
 *
 * Usage:
 *   node scripts/scrape-all-rishon-lezion-events.mjs                              # dry-run
 *   node scripts/scrape-all-rishon-lezion-events.mjs --apply                       # write to DB
 *   node scripts/scrape-all-rishon-lezion-events.mjs --json prisma/data/events-rishon-lezion.json
 *   node scripts/scrape-all-rishon-lezion-events.mjs --debug                       # dump DOM per page
 */
...
async function main() {
  separator();
  console.log(bold(cyan("  Rishon LeZion Venue Scraper — היכל התרבות ראשון לציון")));
  console.log(
    dim(
