 ...
 *
 * Usage:
 *   node scripts/find-missing-gesher-shows.mjs                # interactive (generates migration)
 *   node scripts/find-missing-gesher-shows.mjs --json          # JSON output
 *   node scripts/find-missing-gesher-shows.mjs --html          # HTML report
 */
