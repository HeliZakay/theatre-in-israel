...
| מרכז | תל אביב, תל אביב-יפו, רמת גן, גבעתיים, חולון, בת ים, פתח תקווה, ראש העין, גני תקווה |
| שרון | נתניה, כפר סבא, רעננה, הרצליה, רמת השרון, נווה ירק, תל מונד, גלילות, אריאל |
| שפלה | ראשון לציון, רחובות, נס ציונה, מודיעין, יבנה, מזכרת בתיה, גבעת ברנר, אייפורט סיטי, איירפורט סיטי, קריית שדה התעופה, אקספו תל אביב |
| ירושלים | ירושלים, מעלה אדומים |
