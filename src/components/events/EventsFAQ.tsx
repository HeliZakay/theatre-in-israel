...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "האתר מרכז מידע מתיאטראות מובילים בכל הארץ — הקאמרי, הבימה, גשר, תיאטרון חיפה, באר שבע, החאן, בית ליסין, תמונע, התיאטרון העברי ועוד. בנוסף יש מידע על היכלי תרבות מרחבי הארץ.",
  },
  {
