...
const VENUE_ALIASES = new Map([
  ...
  // Mishkan Beer Sheva — variants from toMix and Incubator scrapers
  ["משכן אמנויות הבמה באר שבע|באר שבע", { name: "המשכן לאומנויות הבמה באר שבע", city: "באר שבע" }],
  ["המשכן לאומנויות הבמה|באר שבע", { name: "המשכן לאומנויות הבמה באר שבע", city: "באר שבע" }],

  // Theatron Haifa — bare hall names → home theatre
  ["במה ראשית|חיפה", { name: "תיאטרון חיפה", city: "חיפה" }],
  ["במה 3|חיפה", { name: "תיאטרון חיפה", city: "חיפה" }],

  // Heichal HaTarbut wrong-city fixes (from old resolveVenueCity bug that
  // assigned every "היכל התרבות X" to תל אביב via the generic substring match)
  ["היכל התרבות נהריה|תל אביב", { name: "היכל התרבות נהריה", city: "נהריה" }],
  ["היכל התרבות חריש|תל אביב", { name: "היכל התרבות חריש", city: "חריש" }],
  ["היכל התרבות באר טוביה|תל אביב", { name: "היכל התרבות באר טוביה", city: "באר טוביה" }],
  ["היכל התרבות כפר יונה|תל אביב", { name: "היכל התרבות כפר יונה", city: "כפר יונה" }],
  ["היכל התרבות נשר|תל אביב", { name: "היכל התרבות נשר", city: "נשר" }],
  ["היכל התרבות קצרין|תל אביב", { name: "היכל התרבות קצרין", city: "קצרין" }],
  ["היכל התרבות קרית גת|תל אביב", { name: "היכל התרבות קרית גת", city: "קרית גת" }],
  ["היכל התרבות פרדס חנה|תל אביב", { name: "היכל התרבות פרדס חנה", city: "פרדס חנה-כרכור" }],
  ["היכל התרבות מרכז הבמה גני תקווה|תל אביב", { name: "מרכז הבמה גני תקווה", city: "גני תקווה" }],
  ["היכל התרבות אייפורט סיטי חבל מודיעין|תל אביב", { name: "היכל התרבות איירפורט סיטי", city: "איירפורט סיטי" }],
  ["היכל התרבות חבל מודיעין - איירפורט סיטי|תל אביב", { name: "היכל התרבות איירפורט סיטי", city: "איירפורט סיטי" }],
  ["היכל התרבות חבל מודיעין - איירפורט סיטי|איירפורט סיטי", { name: "היכל התרבות איירפורט סיטי", city: "איירפורט סיטי" }],
  ['היכל התרבות "ספי ריבלין" מרכז קהילתי קריית השרון|תל אביב', { name: 'היכל התרבות "ספי ריבלין" מרכז קהילתי קריית השרון', city: "נתניה" }],
  ...
  ["תיאטרון יוקנעם|לא ידוע", { name: "תיאטרון יוקנעם", city: "יוקנעם" }],
  ['היכל התרבות "ספי ריבלין" מרכז קהילתי קריית השרון|לא ידוע', { name: 'היכל התרבות "ספי ריבלין" מרכז קהילתי קריית השרון', city: "נתניה" }],
...
const CITY_REGIONS_MAP = {
  ...
  'חיפה': ['north'], 'עכו': ['north'], 'כרמיאל': ['north'], 'עפולה': ['north'], 'קריית מוצקין': ['north'], 'קרית מוצקין': ['north'], 'קריית חיים': ['north'], 'זכרון יעקב': ['north'], 'יגור': ['north'], 'חוף הכרמל': ['north'], 'אור עקיבא': ['north'], 'מועצה אזורית עמק יזרעאל': ['north'], 'עמק המעיינות': ['north'], 'נהריה': ['north'], 'נשר': ['north'], 'קצרין': ['north'], 'חריש': ['north'], 'פרדס חנה-כרכור': ['north', 'sharon'], 'שער העמקים': ['north'],
  'באר שבע': ['south'], 'אשדוד': ['south', 'shfela'], 'אשקלון': ['south'], 'באר טוביה': ['south', 'shfela'], 'קרית גת': ['south'], 'קריית גת': ['south'],
  'כפר יונה': ['sharon'],
};
