...
const CITY_REGIONS_MAP = {
  ...
  'חיפה': ['north'], 'עכו': ['north'], 'כרמיאל': ['north'], 'עפולה': ['north'], 'קריית מוצקין': ['north'], 'קרית מוצקין': ['north'], 'קריית חיים': ['north'], 'זכרון יעקב': ['north'], 'יגור': ['north'], 'חוף הכרמל': ['north'], 'אור עקיבא': ['north'], 'מועצה אזורית עמק יזרעאל': ['north'], 'עמק המעיינות': ['north'],
