...
// ---------------------------------------------------------------------------
// Venue alias normalization + city-region mapping — extracted to sync-helpers.js
// for testability. Imported here for use in syncEvents().
// ---------------------------------------------------------------------------
const { VENUE_ALIASES, CITY_REGIONS_MAP, normalizeVenue } = require("./sync-helpers");
